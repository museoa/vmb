...
#line 736 "mmix-sim.ch"
{"UNSAVE",0x82,0,20,1,"%#z: rG=%x, ..., rL=%a"},
{"SYNC",0x01,0,0,1,"%z"},
#line 1726 "mmix-sim.w"
{"SWYM",0x00,0,0,1,""},
...
if((a.l&0x7)||m+8> size)/*89:*/
#line 1413 "mmix-sim.ch"
...
/*:89*/
#line 1407 "mmix-sim.ch"

else/*90:*/
#line 1423 "mmix-sim.ch"
...
/*:92*/
#line 1461 "mmix-sim.ch"

else/*93:*/
#line 1474 "mmix-sim.ch"
...
register tetra f;
#line 713 "mmix-sim.ch"
register int i,j,k;
register char*p;

/*:41*/
#line 1786 "mmix-sim.ch"
;
/*118:*/
#line 1856 "mmix-sim.ch"
...
/*:14*//*55:*/
#line 788 "mmix-sim.ch"

/*56:*/
#line 799 "mmix-sim.ch"
...
#line 268 "mmix-sim.ch"
/*:23*/
#line 298 "mmix-sim.ch"
while(!postamble);
/*32:*/
#line 608 "mmix-sim.ch"
...
/*:86*//*87:*/
#line 1308 "mmix-sim.ch"

case TRIP:exc|= H_BIT;break;
case TRAP:
if(inst==0)gdb_signal= -1,breakpoint= true;
...
/*:103*/
#line 675 "mmix-sim.ch"
;
/*104:*/
#line 2658 "mmix-sim.w"

if(tracing){
#line 1683 "mmix-sim.ch"
/*106:*/
#line 1709 "mmix-sim.ch"
