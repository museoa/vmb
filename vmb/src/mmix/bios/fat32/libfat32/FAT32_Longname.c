...
//-----------------------------------------------------------------------------
// FATLongname_is_lfn_entry: If LFN text entry found returns sequence number, 0 otherwise
...
//-----------------------------------------------------------------------------
// FATLongname_is_sfn: the entry is a simple short file entry
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// FATLongname_LFN_to_entry_count:
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// FATLongname_Create_sfn_entry: Create the short filename directory entry
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// FATLongname_Create_sfn: Create a padded SFN 
//-----------------------------------------------------------------------------

static void FATLongname_Create_sfn(BYTE *shortname, char *filename)
...
static bool FATLongname_GenerateTail(BYTE *sfn, UINT32 tailNum)
{
	int tail_chars;
	char tail_str[8];
...
//-----------------------------------------------------------------------------
// FATLongname_Create_sfn_with_tail: Create a padded SFN 
//-----------------------------------------------------------------------------
...
{   int tailNum = 0;
    FATLongname_Create_sfn(shortFilename, filename);
    do 
    {   // Check if entry exists already or not
	  ...
	  return 0;
        ...
        tailNum++;
        FATLongname_GenerateTail(shortFilename, tailNum);
    }
