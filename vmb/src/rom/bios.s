...
%	rWW should be the entry point in the main program, thats where the porgram
...
%	and we end the program before it has started in the Trap handler.
	...
	RESUME  1                % loading an elf file sets up special registers for that
...
%	      ORMH      $2,#0000
              STTU      $0,$1,$2
%              SYNC	  5       %empty write buffer to update screen
...
% the virtual Address is part of the pool segment from #4000... to #5FFFF...
