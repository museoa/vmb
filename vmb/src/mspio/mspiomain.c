...
int main(int argc, char *argv[])
{
  ...
  vmb_register(&vmb,HI32(vmb_address),LO32(vmb_address), /* start address, hi 32bit, lo 32 bit
                                         where the device is mapped. */
               memsize, /* the size of the mapped area */
               ...
               "Digital I/O for MSP430");         /* the name of this device */
