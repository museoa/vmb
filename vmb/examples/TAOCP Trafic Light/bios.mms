...
DTrapTimer	POP	0,0	%ignore

DTrapButton	SETH	$0,#8000	%address of ButtonState
		INCMH	$0,#0001
		STCO	1,$0,0		% set ButtonState
		POP	0,0
...
%             The LEDs at address B0 B8 C0 and C8
%	      correspond to the 4 low byte of $255
%		Bits that are 1 in $255 will turn the corresponding
%		LED on, all other LEDs are unchanged
IO		IS	#8001
LEDPort		IS	#B0
	

TrapLOn		GET	$0,rBB		%get the $255 parameter: address and RGB
	      	SETH	$1,IO
	      	LDBU	$2,$1,LEDPort+0
	      	AND	$3,$0,#FF
	      	OR	$2,$2,$3
...
TrapLOff	GET	$0,rBB		%get the $255 parameter: address and RGB
	      	SETH	$1,IO
	      	LDBU	$2,$1,LEDPort+0
	      	AND	$3,$0,#FF
	      	ANDN	$2,$2,$3
...
TrapTWait	SET	$0,1
		...
		GET	$1,rQ
		ANDN	$2,$1,$0
		PUT	rQ,$2		%Clear Timer Interrupt
		GET	$2,rBB	
		BNP	$2,2F
		SETH	$3,IO
		STTU	$2,$3,TPort+t
...
%		return immediately if button was called since this function
%		was last called
BInt		IS	48

TrapBWait	SETH	$0,#8000
		INCMH	$0,#0001
		LDO	$1,$0,0	% Get Button State
		BNZ	$1,3F
...
%	  .global	FreeSpace
% RAMSTART    LOC	#8000000100000000 %First page is for OS
