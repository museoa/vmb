...
3H	LDO	$2,$1,0		%keyboard status/data
	...
	AND	$2,$2,#FF	%got char in $2
	GET	$4,rJ
	SET	$6,$2
	PUSHJ	$5,ScreenC	%echo
	CMP	$3,$2,#0D	%carriage return
	BNZ	$3,1F		
	SET	$2,#0A		%make it a line feed
	SET	$6,$2		%and echo in addition
	PUSHJ	$5,ScreenC
1H	PUT	rJ,$4
	SET	$0,$2
	POP	1,0
...
DTrapMouse	GETA	$0,1F
		...
		POP	0,0
1H		BYTE	"DEBUG Mouse Interrupt",0
...
TrapTTimeOfDay	SETH    $1,#8001	%base address of timer -60
		LDTU	$0,$1,#6C
		PUT	rBB,$0
		POP	0,0
...
TrapGPutChar 	GET	$0,rBB		%get the $255 parameter: c, x, y
              	SETH    $1,#8001	%base address of gpu -20
              	ORH	$0,#0100	% add the Write Character Command
              	STTU	$0,$1,#2c	store position
              	STHT	$0,$1,#20
	     	POP	0,0
...
TrapGLine	GET	$0,rBB		%get the $255 parameter:  x, y, 
		ORH	$0,#0300	the draw line command
              	SETH    $1,#8001	%base address of gpu -20
		STO	$0,$1,#20
		POP	0,0	

TrapGRectangle	POP	0,0
...
TrapGBitBltIn   GET	$0,rBB		%get the $255 parameter: x,y
              	SETH    $1,#8001	%base address of gpu -20
              	LDO	$2,$0,0
              	STO	$2,$1,#28
              	LDO	$2,$0,8
              	ANDN	$3,$2,#7	OCTA align
              	AND	$4,$2,#7	OCTA offset		
              	LDVTS	$5,$3,6		Translate to physical using data VTC
              	ANDN	$5,$5,#7	remove permission bits
              	ADD	$5,$5,$4        add OCTA offset
              	STO	$5,$1,#30
...
ScreenC	SETH	$1,#8001
        ORML	$0,#0100		command in top 8 bit
	STT	$0,$1,#20
	POP	0,0
